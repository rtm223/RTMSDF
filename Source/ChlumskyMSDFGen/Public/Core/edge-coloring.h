 ...
 */
void CHLUMSKYMSDFGEN_API edgeColoringSimple(Shape &shape, double angleThreshold, unsigned long long seed = 0);
 ...
 */
void CHLUMSKYMSDFGEN_API edgeColoringInkTrap(Shape &shape, double angleThreshold, unsigned long long seed = 0);
 ...
 */
void CHLUMSKYMSDFGEN_API edgeColoringByDistance(Shape &shape, double angleThreshold, unsigned long long seed = 0);

...
public:
	UPROPERTY(EditAnywhere, Category="SVG File Rules", Config, meta=(DisplayName="SVG Filename Prefix"))
	...
	UPROPERTY(EditAnywhere, Category="Bitmap File Rules", Config, meta=(DisplayName="Bitmap Filename Prefix"))
